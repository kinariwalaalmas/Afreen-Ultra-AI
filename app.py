...
st.title("👸 Afreen Pro")
# UI components update: ID scanner and normal tools
id_input, scan_btn, audio, photo = render_plus_menu()

# Logic for Scanner or Chat
...
if user_msg:
    ...
    with st.spinner("Afreen is searching the world for you..."):
        # Auto-detect context (Global News or OSINT)
        context = osint_scanner(user_msg)
