...
if user_msg:
    ...
    with st.spinner("Thinking..."):
        ...
        chat_completion = groq_client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": f"You are Afreen, a sweet Hinglish girl. Address user as 'Jaan' and use MASCULINE grammar. Info: {search_info}. Help Jaan with his clothing business in Surat."},
                *st.session_state.messages
            ]
        )
